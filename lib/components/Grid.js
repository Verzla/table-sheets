...
function Grid({ data, columns, styleVariables }) {
    ...
    return ((0, jsx_runtime_1.jsx)(GridContext_1.GridContext.Provider, { value: gridState, children: (0, jsx_runtime_1.jsxs)("div", { className: 'ts-grid', style: { gridTemplateRows: (0, GridStyleFuncs_1.GetGridRows)(data.length) }, ref: ref, children: [(0, jsx_runtime_1.jsx)("div", { className: 'ts-header', style: { gridRow: 1 }, children: columns.map((c, cIndex) => ((0, jsx_runtime_1.jsx)("div", { children: c.title(data[cIndex]) }, `gh_${cIndex}`))) }), data.map((d, dIndex) => ((0, jsx_runtime_1.jsx)("div", { className: 'ts-row', style: { gridRow: dIndex + 2 }, children: columns.map((c, cIndex) => ((0, jsx_runtime_1.jsx)(GridCell_1.GridCell, { readonly: c.readonly, cursor: [dIndex, cIndex], render: (state) => c.value(d, state) }, `gc_${cIndex}`))) }, `gr_${dIndex}`)))] }) }));
}
exports.Grid = Grid;

...
function Autocomplete(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: 'ts-autocomplete', ref: ref, children: [(0, jsx_runtime_1.jsx)(Input_1.Input, Object.assign({}, props, { value: search, onChange: (e) => setSearch(e.target.value), onDoubleClickCapture: () => setFocused(true), onBlur: () => setTimeout(() => setFocused(false), 250), ref: inputRef })), focused && ((0, jsx_runtime_1.jsx)("div", { className: 'ts-autocomplete-items', children: availableOptions.map((d, dIndex) => ((0, jsx_runtime_1.jsx)("div", { className: dIndex === itemFocused ? 'ts-autocomplete-active' : '', onClick: () => {
                        updateOnChange(d);

...
function Autocomplete(_a) {
    ...
    const [search, setSearch] = (0, react_1.useState)((_b = selectedDataValue === null || selectedDataValue === void 0 ? void 0 : selectedDataValue.content) !== null && _b !== void 0 ? _b : '');
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: Autocomplete_module_css_1.default.autocomplete, ref: ref, children: [(0, jsx_runtime_1.jsx)(Input_1.Input, Object.assign({}, props, { value: search, onChange: (e) => setSearch(e.target.value), onDoubleClickCapture: () => setFocused(true), onBlur: () => {
                    setTimeout(() => {
                        setFocused(false);
                    }, 1);
